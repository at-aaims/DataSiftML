...
parser.add_argument("--target", type=str, default='wz', choices=['wz', 'p', 'stream'], help="training target")
...
parser.add_argument("--num_time_stamps", type=int, default=100, help="OpenFOAM number of timestamps")
